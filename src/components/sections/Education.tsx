        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-foreground/70 text-lg max-w-2xl mx-auto">
              My academic journey and the educational experiences that have shaped my expertise
            </p>
          </div>
        ...
        <div className="bg-background border border-foreground/10 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow duration-300">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
            ...
            <div className="flex flex-col items-start sm:items-end mt-2 sm:mt-0">
              <span className="text-sm font-medium text-foreground/80">{education.duration}</span>
              <span className="text-sm text-foreground/60">GPA: {education.gpa}</span>
            </div>
          </div>
          ...
          {/* Projects */}
          <div className="mb-6">
            <h4 className="font-medium text-foreground mb-3">Relevant Projects</h4>
            <ul className="space-y-2">
